		...
		try {
			...
			if (res.ok) {
				...
				if (latestTag && latestTag !== appVersion) {
					...
					updateMessage = `New version available: v${latestTag}`;
				} else {
	...
	<div class="settings-page">
		...
		<section class="settings-section">
			...
			<div class="about-links">
				<a href="https://github.com/soumyachk101/SwarmAI-V1" target="_blank" rel="noopener" class="about-link">
				...
				<a href="https://github.com/soumyachk101/SwarmAI-V1/releases" target="_blank" rel="noopener" class="about-link">
