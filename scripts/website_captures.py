...
The app runs once in its capture mode (see DroppyCode/Support/WebsiteCaptures.swift): it
...
and, for --upload, wrangler signed in to the Droppy Cloudflare account.
"""
