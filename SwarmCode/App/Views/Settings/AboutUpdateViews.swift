...
// The software update story on the About page, told the way Swarm's settings tell it: the
...
/// A pill track filling with the Swarm icon's blues behind a soft white head, sparkles
...
struct AboutSoftwareUpdateSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Chrome.sectionSpacing) {
            // The cards lead the page on their own, as on Swarm's About page; the version is
