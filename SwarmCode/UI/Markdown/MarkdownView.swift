...
enum RichLink {
    ...
    /// A bare domain as people type it in chat: getswarm.app, www.swarm.app/pricing?a=1.
    ...
    /// Links the bare domains Foundation leaves alone: `getswarm.app` typed in chat
