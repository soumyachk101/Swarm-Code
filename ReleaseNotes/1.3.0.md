...
- While a turn runs, the working line is the head panel's progress card: the task breathing, the stave bar filling with the turn's steps, the time in its pill, and the chevron opening the steps.
