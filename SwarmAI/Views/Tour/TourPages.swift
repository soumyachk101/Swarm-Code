...
enum Tour {
    static let pages: [TourPage] = [
        ...
        TourPage(imageName: "tour-themes", title: "Make it yours", description: "Twenty-five themes, from Catppuccin to Kanagawa, in real Liquid Glass. Built in Swift, so it scrolls at 120 frames a second and starts in a blink."),
    ]
