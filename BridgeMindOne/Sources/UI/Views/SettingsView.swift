...
public struct GeneralSettings: Equatable {
 public var appName: String = AppConfig.displayName
...
private struct GeneralSettingsView: View {
 ...
 ForEach(EngineType.allCases, id: \.rawValue) { engine in
...
private struct EnginePathsView: View {
 ...
 PathField(label: "Claude CLI", path: $paths.claudePath)
 PathField(label: "Codex CLI", path: $paths.codexPath)
 PathField(label: "Aider", path: $paths.aiderPath)
 }
...
private struct APIKeysView: View {
 ...
 ("Google AI API Key", $settings.googleKey)
 ]
 }
}
