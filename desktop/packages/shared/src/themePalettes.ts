...
/** The standard Swarm Code palette, kept separate from the optional built-in theme library. */
...
/**
 * The palette Swarm Code wears with no theme installed, captured from the app's
 ...
 */
export const SWARM_CODE_LIGHT_THEME_COLORS: ThemeColors = {
  canvas: "#fcfcfc",
  chrome: "#fcfcfc",
  toolbar: "#fcfcfc",
...
export const SWARM_CODE_DARK_THEME_COLORS: ThemeColors = {
  canvas: "#0a0a0a",
  chrome: "#0a0a0a",
  toolbar: "#0a0a0a",
...
export const SWARM_CODE_CHAT_THEME: ThemeDefinition = {
  id: "t3-chat",
  label: "Swarm Code Chat",
  appearance: "light",
  colors: {
...
export const T3_CHAT_THEME = SWARM_CODE_CHAT_THEME;
