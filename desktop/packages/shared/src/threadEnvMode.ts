import type { ThreadEnvMode } from "@swarmcode/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in swarmCode.json > global server setting.
 *
 ...
 * source that outranks swarmCode.json decided, or the file read settled. While
