...
const URL_GUIDANCE =
  "Absolute http(s) URL or a schemeless host such as swarmcode.chat or localhost:5173. Schemeless public hosts use https; loopback hosts use http.";
...
/** A `swarm-code` MCP tool was called with a credential that does not carry its capability. */
