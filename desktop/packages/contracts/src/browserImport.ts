 ...
 * machine into a Swarm Code browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Swarm Code profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Swarm Code Full Disk Access in System Settings → Privacy & Security, then retry.",
