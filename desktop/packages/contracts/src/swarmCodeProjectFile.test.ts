...
import { SwarmCodeProjectFile } from "./swarmCodeProjectFile.ts";

const decode = Schema.decodeUnknownSync(SwarmCodeProjectFile);

describe("SwarmCodeProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://swarmcode.vercel.app/schema/swarmCode.json",
