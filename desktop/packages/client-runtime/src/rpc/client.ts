import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@swarmcode/contracts";
...
}>("@swarmcode/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@swarmcode/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
