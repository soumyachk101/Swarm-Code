...
import { classifyMarkdownImageSource } from "@swarmcode/client-runtime/markdown-images";
import { resolveMediaSource } from "@swarmcode/client-runtime/media-source";
import { parseChangeRequestUrl } from "@swarmcode/shared/changeRequestUrl";
import { isWorkspaceImagePreviewPath } from "@swarmcode/shared/filePreview";
...
> = {
  ...
  create_threads: ["Create", "Creating", "Created", "a Swarm Code threads"],
  t3_thread_start: ["Start", "Starting", "Started", "a a Swarm Code thread"],
  t3_thread_list: ["List", "Listing", "Listed", "a Swarm Code threads"],
  t3_thread_read: ["Read", "Reading", "Read", "a a Swarm Code thread"],
  t3_thread_send: ["Send", "Sending", "Sent", "to a a Swarm Code thread"],
  t3_thread_wait: ["Wait", "Waiting", "Waited", "for a a Swarm Code thread"],
  t3_thread_interrupt: ["Interrupt", "Interrupting", "Interrupted", "a a Swarm Code thread"],
