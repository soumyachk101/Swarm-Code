import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@swarmcode/contracts";
import { resolveRemotePairingTarget } from "@swarmcode/shared/remote";
...
>()("@swarmcode/client-runtime/connection/onboarding/ConnectionOnboarding") {}
