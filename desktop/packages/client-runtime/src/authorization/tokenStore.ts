...
import { RelayManagedEndpoint } from "@swarmcode/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@swarmcode/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@swarmcode/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
