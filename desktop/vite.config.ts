...
const RESTRICTED_IMPORT_PATHS = [
  {
    name: "@swarmcode/client-runtime",
    message:
      "Import from an explicit @swarmcode/client-runtime/* subpath. The package has no root export.",
  },
  {
...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-swarmcode/index.ts"],
    categories: {
      correctness: "warn",
      suspicious: "warn",
      perf: "warn",
    ...
    rules: {
      ...
      "swarmcode/no-global-process-runtime": "error",
      "swarmcode/no-inline-schema-compile": "warn",
      "swarmcode/no-manual-effect-runtime-in-tests": "error",
      "swarmcode/no-native-title-tooltip": "error",
      "swarmcode/namespace-node-imports": "error",
    },
    overrides: [
      {
        // The one place that reads the host platform to seed the injected references.
        files: ["packages/shared/src/hostProcess.ts"],
        rules: { "swarmcode/no-global-process-runtime": "off" },
      },
      {
      ...
      },
      {
        ...
        rules: { "swarmcode/no-mobile-uniwind-theme-escape-hatches": "error" },
      },
      {
        ...
        rules: { "swarmcode/no-hermes-unsupported-apis": "error" },
      },
      {
        ...
        files: [
          ...
          "apps/mobile/src/native/SwarmComposerEditor.ios.tsx",
          "apps/mobile/src/native/SwarmComposerEditor.native.tsx",
          "apps/mobile/src/native/SelectableMarkdownText.android.tsx",
        ],
        rules: {
          "swarmcode/no-mobile-uniwind-theme-escape-hatches": ["error", { allowUniwindTheme: true }],
        },
      },
      ...
      ...Object.entries({
        ...
        return { files: [file], rules: { "swarmcode/no-manual-effect-runtime-in-tests": rule } };
      }),
    ],
    options: {
