export const BRAND_ASSET_PATHS = {
  ...
  productionWindowsIconIco: "assets/prod/swarm-code-windows.ico",
  productionWebFaviconIco: "assets/prod/swarm-code-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/swarm-code-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/swarm-code-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/swarm-code-web-apple-touch-180.png",
