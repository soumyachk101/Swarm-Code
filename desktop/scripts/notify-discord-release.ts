  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Swarm Code prerelease is available for nightly testers."
          : "A new Swarm Code latest release is available.",
...
).pipe(Command.withDescription("Post a Swarm Code release announcement to Discord."));
