...
const NAME = "org.gnome.Shell.Extensions.SwarmCodeSnapShot";
const PATH = "/org/gnome/Shell/Extensions/SwarmCodeSnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`Swarm Code capture preview unavailable: ${error.message}`);
    }
  }
...
export default class SwarmCodeSnapShotExtension extends Extension {
  enable() {
