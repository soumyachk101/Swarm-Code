import { fromLenientJson } from "@swarmcode/shared/schemaJson";
...
export const resolveLinuxDesktopEntryName = (isDevelopment: boolean): string =>
  isDevelopment ? "com.swarmcode.swarmcode.Development.desktop" : "com.swarmcode.swarmcode.desktop";
...
function resolveEarlyDesktopSettingsPath(input: {
  ...
  const swarmcodeHome = Option.fromUndefinedOr(input.env.SWARMCODE_HOME);
