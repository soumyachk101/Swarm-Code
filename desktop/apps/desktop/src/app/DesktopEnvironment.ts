...
import type { OtlpProtocol } from "@swarmcode/shared/observability";
...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    // Built web client the packaged renderer is served from over swarmcode://app.
    readonly clientAssetsDir: string;
    readonly backendCwd: string;
    readonly preloadPath: string;
    readonly appUpdateYmlPath: string;
    readonly devServerUrl: Option.Option<URL>;
    readonly devRemoteSwarmCodeServerEntryPath: Option.Option<string>;
...
>()("@swarmcode/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "Swarm Code";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = resolveDesktopBaseDir({
    homeDirectory,
    joinPath: path.join,
    swarmcodeHome: config.swarmcodeHome,
  });
  ...
  const userDataDirName = isDevelopment ? "swarmcode-dev" : "swarmcode";
  const legacyUserDataDirName = isDevelopment ? "Swarm Code (Dev)" : "Swarm Code";
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteSwarmCodeServerEntryPath: config.devRemoteSwarmCodeServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.swarmcode.swarmcode.dev" : "com.swarmcode.swarmcode",
    ),
    linuxDesktopEntryName: resolveLinuxDesktopEntryName(isDevelopment),
    linuxWmClass: isDevelopment ? "swarmcode-dev" : "swarmcode",
