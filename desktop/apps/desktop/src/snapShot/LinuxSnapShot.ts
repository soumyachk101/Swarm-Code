...
const EXTENSION = "org.gnome.Shell.Extensions.SwarmCodeSnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/SwarmCodeSnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another Swarm Code instance is capturing a window. Try again.");
    }
