...
>()("@swarmcode/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__SWARMCODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__SWARMCODE_ENV_${name}_END__`;
