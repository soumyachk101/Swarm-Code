import type { DesktopSshPasswordPromptRequest } from "@swarmcode/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@swarmcode/contracts";
import type { SshPasswordRequest } from "@swarmcode/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedError<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Swarm Code window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@swarmcode/desktop/ssh/DesktopSshPasswordPrompts") {}
