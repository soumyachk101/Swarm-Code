...
import type { DesktopUpdateState } from "@swarmcode/contracts";
    ...
    Layer.provide(
      Layer.mergeAll(
        ...
        DesktopConfig.layerTest({
          SWARMCODE_HOME: `/tmp/t3-desktop-updates-test-${process.pid}`,
          SWARMCODE_DESKTOP_MOCK_UPDATES: "true",
          SWARMCODE_DESKTOP_MOCK_UPDATE_SERVER_PORT: "4141",
          ...options.env,
        }),
      ),
    ),
