      ...
      yield* Effect.scoped(
        Effect.gen(function* () {
          ...
          yield* protocol.registerDesktopProtocol({
            ...
            clerkFrontendApiHostname: "clerk.swarmcode.dev",
          });
          ...
          assert.include(
            ...
            "script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval' https://clerk.swarmcode.dev https://challenges.cloudflare.com",
          );
          assert.include(
            response.headers.get("content-security-policy") ?? "",
