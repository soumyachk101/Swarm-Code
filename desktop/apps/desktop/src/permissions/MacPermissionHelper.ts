...
<header>↑ Drag Swarm Code into the list above</header>
<button id="app" draggable="true" aria-label="Drag Swarm Code to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">Swarm Code</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged Swarm Code icon is missing.");
