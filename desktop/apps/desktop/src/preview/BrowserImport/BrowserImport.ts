 ...
 * into a Swarm Code browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@swarmcode/contracts";
...
import { HostProcessExecutablePath, HostProcessPlatform } from "@swarmcode/shared/hostProcess";
...
>()("@swarmcode/desktop/preview/BrowserImport/BrowserImport") {}
