...
import type { RemoteSwarmCodeRunnerOptions } from "@swarmcode/ssh/tunnel";
...
): RemoteSwarmCodeRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteSwarmCodeServerEntryPath);
