...
import { waitForHttpReady as waitForHttpReadyShared } from "@swarmcode/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/swarm-code/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // SWARMCODE_HOME can't pin the WSL backend to /mnt/c/...\.t3.
