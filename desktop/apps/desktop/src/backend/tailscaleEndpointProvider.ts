import { createAdvertisedEndpoint } from "@swarmcode/shared/advertisedEndpoint";
import type { AdvertisedEndpoint, AdvertisedEndpointProvider } from "@swarmcode/contracts";
import {
...
export { parseTailscaleMagicDnsName } from "@swarmcode/tailscale";
