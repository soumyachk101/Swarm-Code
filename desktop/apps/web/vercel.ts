...
const ROUTER_HOST = "swarmcode.vercel.app";
const HOSTED_WEB_CHANNEL_COOKIE = "t3code_web_channel";
const LATEST_ORIGIN = "https://latest.swarmcode.vercel.app";
const NIGHTLY_ORIGIN = "https://nightly.swarmcode.vercel.app";
...
export const config: VercelConfig = {
  buildCommand:
    'vp run --filter @swarmcode/web build && node ../../scripts/apply-web-brand-assets.ts --channel "${VITE_HOSTED_APP_CHANNEL:-latest}"',
  git: {
    deploymentEnabled: false,
  },
  installCommand:
    "npm install -g vite-plus && vp install --ignore-scripts --filter '@swarmcode/scripts...' --filter '@swarmcode/web...'",
  routes: [
    {
