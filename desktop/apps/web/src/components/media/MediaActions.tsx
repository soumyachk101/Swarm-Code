import type { MediaActionId } from "@swarmcode/client-runtime/media-actions";
import {
  mediaReferenceFileName,
  type MediaReference,
} from "@swarmcode/client-runtime/media-reference";
import { resolveAssetUrl } from "@swarmcode/client-runtime/state/assets";
import { squashAtomCommandFailure } from "@swarmcode/client-runtime/state/runtime";
import type { AssetResource, ContextMenuItem, EnvironmentId } from "@swarmcode/contracts";
