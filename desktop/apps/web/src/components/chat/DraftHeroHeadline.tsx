...
import { resolveEnvironmentMachineKind, type ScopedProjectRef } from "@swarmcode/contracts";
import { scopedProjectKey, scopeProjectRef } from "@swarmcode/client-runtime/environment";
