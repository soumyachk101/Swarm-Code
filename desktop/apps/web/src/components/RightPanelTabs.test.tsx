import { EnvironmentId, type ThreadPullRequestLink } from "@swarmcode/contracts";
import type { DesktopPreviewFavicon, PreviewSessionSnapshot } from "@swarmcode/contracts";
