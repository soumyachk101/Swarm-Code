...
import type { EnvironmentThreadShell } from "@swarmcode/client-runtime/state/shell";
import { useProjects, useServerConfigs, useThreadShells } from "~/state/entities";
import {
  threadPullRequestKeysEqual,
  visibleThreadPullRequests,
} from "@swarmcode/shared/threadPullRequests";
import type {
  ContextMenuItem,
  EnvironmentId,
...
import { getTerminalLabel } from "@swarmcode/shared/terminalLabels";
import {
  Bot,
  Smartphone,
  ChevronDown,
...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the Swarm Code desktop app.",
