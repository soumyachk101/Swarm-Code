...
const NO_FILE_SCRIPTS: ReadonlyArray<SwarmCodeProjectFileScript> = [];

interface ProjectScriptsControlProps {
  presentation?: "toolbar" | "menu";
  onRequestMenuClose?: () => void;
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in swarmCode.json, offered for import. */
  fileScripts?: ReadonlyArray<SwarmCodeProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: SwarmCodeProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From swarmCode.json</MenuGroupLabel>
