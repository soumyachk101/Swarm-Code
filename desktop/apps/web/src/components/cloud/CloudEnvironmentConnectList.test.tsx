import type { Discovery } from "@swarmcode/client-runtime/relay";
import type { AtomCommandResult } from "@swarmcode/client-runtime/state/runtime";
import { EnvironmentId, ORCHESTRATION_PROTOCOL_VERSION } from "@swarmcode/contracts";
