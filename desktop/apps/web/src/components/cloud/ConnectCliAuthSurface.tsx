...
import { readConnectAuthorizeRequest } from "@swarmcode/shared/connectAuth";
...
const invalidLinkMessage = {
  ...
  description:
    "The link is missing its authorization request. Re-run `swarm connect` in your terminal and open the freshly printed URL.",
} as const;
  ...
  return (
    <AuthSurfaceShell>
      <ConnectCliAuthMessage
        ...
        description={
          isSignedIn
            ? "Redirecting to authorize Swarm Connect for your CLI…"
            : "Sign in to continue authorizing Swarm Connect for your CLI."
        }
      />
      {isLoaded && !isSignedIn ? (
        <div className="mt-6">
