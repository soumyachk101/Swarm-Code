...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@swarmcode/contracts";
...
/**
 * Post-sign-in onboarding wizard for Swarm Connect. Opens on every in-session
 ...
 * account's Swarm Connect environments so every device can be connected right
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Swarm Connect."
