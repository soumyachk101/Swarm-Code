...
import { resolveThreadCurrentPullRequestLink } from "@swarmcode/shared/threadPullRequests";
...
import { resolveSettledThreadTimestamp } from "@swarmcode/client-runtime/state/thread-sort";
import {
  threadSearchMatchKey,
  type EnvironmentThreadSearchMatch,
} from "@swarmcode/client-runtime/state/thread-search";
import type { EnvironmentThreadShell } from "@swarmcode/client-runtime/state/models";
import {
...
import type { EnvironmentProject } from "@swarmcode/client-runtime/state/shell";
...
export default function Sidebar() {
  ...
  // Threads on non-primary environments (Swarm Connect, hosted) resolve their
