import { withDeviceHubQuery } from "@swarmcode/client-runtime/state/deviceHubAccess";
import type { DeviceHubAccess } from "@swarmcode/client-runtime/state/deviceHubAccess";
import type { DevicePlatform } from "@swarmcode/contracts";
