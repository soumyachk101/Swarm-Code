...
import { visibleThreadPullRequests } from "@swarmcode/shared/threadPullRequests";
import type { UsageLimitSourceSnapshots } from "@swarmcode/contracts";
import {
  collectProviderUsageLimits,
  hasProviderUsageLimits,
  isUsageLimitsCommand,
} from "@swarmcode/shared/usageLimits";
import { feedbackBannerItem } from "./chat/ComposerFeedback";
import { usageLimitsBannerItem } from "./chat/ComposerUsageLimits";
import { derivePendingRequests } from "@swarmcode/client-runtime/pending-requests";
import {
...
import { type EnvironmentConnectionPresentation } from "@swarmcode/client-runtime/connection";
import {
  wasBootstrapThreadDeleted,
  wasBootstrapThreadNotCreated,
} from "@swarmcode/client-runtime/errors";
import { readPastedComposerContext } from "./composerInlineTokenPaste";
import { isPasteAsTextShortcut } from "@swarmcode/client-runtime/text-paste";
import { type CodexArtifactTemplate } from "@swarmcode/client-runtime/codex-artifact-templates";
import { effectiveSnoozed, threadWokeAt } from "@swarmcode/client-runtime/state/thread-settled";
import {
  parseCodexFeedbackCommand,
  submitCodexFeedback,
  type CodexFeedbackSubmission,
} from "@swarmcode/client-runtime/state/threads";
import {
  parseScopedThreadKey,
  scopedThreadKey,
  scopeProjectRef,
  scopeThreadRef,
} from "@swarmcode/client-runtime/environment";
import {
...
} from "@swarmcode/shared/projectScripts";
import { resolveProjectSettings } from "@swarmcode/shared/projectSettings";
import { sourceControlRepositorySelector } from "@swarmcode/shared/sourceControl";
import { truncate } from "@swarmcode/shared/String";
import { resolveThreadReferenceCopyTarget } from "@swarmcode/shared/threadReference";
import {
  getTerminalLabel,
  nextTerminalId,
  resolveTerminalSessionLabel,
} from "@swarmcode/shared/terminalLabels";
...
import { assistantCitationsToPlainText } from "@swarmcode/shared/assistantCitations";
...
import { buildTemporaryWorktreeBranchName } from "@swarmcode/shared/git";
...
} from "@swarmcode/client-runtime/state/subagentRuntime";
...
import { serializeLegacyContextMessage } from "@swarmcode/shared/composerContextLegacySend";
import {
  buildMessageContext,
...
import { resolveProviderSkillsForCwd } from "@swarmcode/client-runtime/providerSkills";
import { vcsEnvironment } from "../state/vcs";
import { sourceControlEnvironment } from "../state/sourceControl";
import { useProjectClone } from "../state/projectClones";
import { projectCloneDisplayName, projectCloneProgressSummary } from "@swarmcode/contracts";
...
import { clampFileAttachmentUploadBytes } from "@swarmcode/client-runtime/state/attachments";
  ...
  const onRespondToUserInput = useCallback(
    async (requestId: ApprovalRequestId, answers: Record<string, unknown>) => {
      ...
      const attachmentsByQuestionId = new Map<
        string,
        import("@swarmcode/contracts").UserInputAttachments[string]
      >();
      for (const question of activePendingUserInput.questions) {
        ...
        attachmentsByQuestionId.set(
          question.id,
          uploaded as import("@swarmcode/contracts").UserInputAttachments[string],
        );
      }
  ...
  const rightPanelContent = activeThreadRef ? (
    renderedRightPanelSurface?.kind === "preview" ? (
      ...
      <PullRequestsUnavailableState
        ...
        error="Update this environment's Swarm Code server to browse pull requests."
      />
