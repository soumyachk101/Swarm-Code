import type { DesktopSshEnvironmentTarget, EnvironmentMachineKind } from "@swarmcode/contracts";
 ...
 * Swarm Connect, SSH, WSL, and plain remote links are told apart without a legend.
 */
