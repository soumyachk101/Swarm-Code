...
import { scopeThreadRef } from "@swarmcode/client-runtime/environment";
import {
...
} from "@swarmcode/contracts/settings";
import { resolveServerBackgroundActivitySettings } from "@swarmcode/shared/backgroundActivitySettings";
    ...
    <SettingsPageContainer>
      ...
      <SettingsSection title="Diagnostics">
        ...
        <SettingsRow
          ...
          description="Notices for dependencies, assets, and optional tools used by Swarm Code."
          control={
            <Button
