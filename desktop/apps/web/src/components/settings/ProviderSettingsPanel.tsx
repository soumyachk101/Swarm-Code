...
import { connectionStatusTitle } from "@swarmcode/client-runtime/connection";
import { safeErrorLogAttributes } from "@swarmcode/client-runtime/errors";
import {
...
import { DEFAULT_UNIFIED_SETTINGS } from "@swarmcode/contracts/settings";
import {
  getBackgroundActivityPresetSettings,
  resolveServerBackgroundActivitySettings,
} from "@swarmcode/shared/backgroundActivitySettings";
...
function providerEnvironmentDetail(environment: EnvironmentPresentation): string {
  ...
  if (environment.relayManaged) return "Swarm Connect";
