...
import { STATIC_KEYBINDING_COMMANDS, type KeybindingCommand } from "@swarmcode/contracts";
import type { EnvironmentId } from "@swarmcode/contracts";
import type { EnvironmentConnectionPhase } from "@swarmcode/client-runtime/connection";
import { DEFAULT_KEYBINDINGS } from "@swarmcode/shared/keybindings";
...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    title: "Actions",
    to: "/settings/projects",
    searchTerms: ["commands scripts setup run dev server checkout worktree swarmCode.json import"],
  },
  {
    id: "environment-icon",
