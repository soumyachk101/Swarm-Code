...
import { DEFAULT_CLIENT_SETTINGS, type DesktopSnapShotState } from "@swarmcode/contracts";
...
it("hides macOS setup only while permissions and the shortcut are all in place", () => {
  ...
  const revoked = {
    ...
    message: "Allow Accessibility in System Settings, then restart Swarm Code.",
  };
