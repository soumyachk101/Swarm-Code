...
const SwarmConnectSidebarSignIn = lazy(() =>
  import("../clerk/SwarmConnectSidebarSignIn").then((module) => ({
    default: module.SwarmConnectSidebarSignIn,
  })),
);
const SwarmConnectSidebarAvatar = lazy(() =>
  import("../clerk/SwarmConnectSidebarSignIn").then((module) => ({
    default: module.SwarmConnectSidebarAvatar,
  })),
);
