...
import type { EnvironmentId, PullRequestRef, ScopedThreadRef, ThreadId } from "@swarmcode/contracts";
...
import { normalizeThreadPullRequestKey } from "@swarmcode/shared/threadPullRequests";
