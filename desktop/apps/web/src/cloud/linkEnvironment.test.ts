...
import { RelayWebClientId } from "@swarmcode/contracts/relay";
...
import { type RpcSession } from "@swarmcode/client-runtime/rpc";
import { EnvironmentRegistry } from "@swarmcode/client-runtime/connection";
import { ManagedRelay } from "@swarmcode/client-runtime/relay";
import { remoteHttpClientLayer } from "@swarmcode/client-runtime/rpc";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_SWARMCODE_RELAY_URL", "https://relay.example.test");
