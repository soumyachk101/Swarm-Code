...
import { EnvironmentId, MessageId, ThreadId, type AssistantCitation } from "@swarmcode/contracts";
import {
  collectAssistantCitations,
  expandAssistantCitationsForProvider,
  serializeAssistantCitation,
} from "@swarmcode/shared/assistantCitations";
...
describe("filterComposerPullRequestMatches", () => {
  const entries = [
    ...
    },
    {
      number: 8987,
      projectId: "project-1",
      repository: "SwarmCodeTools/SwarmCode",
