...
} from "@swarmcode/client-runtime/pending-requests";
import { UserInputAttachmentAnswerPayload } from "@swarmcode/contracts";
import { foldUserInputActivities } from "@swarmcode/client-runtime/work-log/user-input";
import * as Option from "effect/Option";
import * as Schema from "effect/Schema";
import * as Arr from "effect/Array";
import { shallow } from "zustand/vanilla/shallow";
import { isBackgroundTaskActivity } from "@swarmcode/client-runtime/state/subagentRuntime";
import {
...
import { extractToolActivityPresentation } from "@swarmcode/client-runtime/work-log/tool-presentation";
import {
...
export type { PendingApproval, PendingUserInput } from "@swarmcode/client-runtime/pending-requests";

export { formatDuration } from "@swarmcode/shared/orchestrationTiming";
...
export interface WorkLogEntry {
  ...
  toolTitle?: string;
  toolSurface?: import("@swarmcode/contracts").ToolActivitySurface;
  toolIcon?: import("@swarmcode/contracts").ToolActivityIcon;
  toolSource?: import("@swarmcode/contracts").ToolActivitySource;
  toolData?: unknown;
