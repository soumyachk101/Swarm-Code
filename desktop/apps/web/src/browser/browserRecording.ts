import { DESKTOP_PREVIEW_RECORDING_CAPTURE_TRIGGER } from "@swarmcode/contracts";
import type { DesktopPreviewRecordingArtifact, ScopedThreadRef } from "@swarmcode/contracts";
