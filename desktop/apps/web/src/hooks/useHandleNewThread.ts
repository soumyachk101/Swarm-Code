...
import { DEFAULT_SERVER_SETTINGS, type ScopedProjectRef, type ThreadId } from "@swarmcode/contracts";
...
import { resolveDefaultThreadEnvMode } from "@swarmcode/shared/threadEnvMode";
...
import { readSwarmCodeProjectFileDefaultThreadEnvMode } from "../lib/swarmCodeProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The swarmCode.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readSwarmCodeProjectFileDefaultThreadEnvMode(
