...
import type { RuntimeMode } from "@swarmcode/contracts";
...
vi.mock("@swarmcode/client-runtime/environment", () => ({
  scopedProjectKey: () => "remote-project",
  scopeProjectRef: (environmentId: string, projectId: string) => ({ environmentId, projectId }),
  scopeThreadRef: (environmentId: string, threadId: string) => ({ environmentId, threadId }),
}));
vi.mock("@swarmcode/contracts", () => ({
  DEFAULT_RUNTIME_MODE: "default",
  DEFAULT_SERVER_SETTINGS: {},
}));
vi.mock("@swarmcode/shared/projectSettings", () => ({
...
vi.mock("@swarmcode/shared/threadEnvMode", () => ({
...
vi.mock("../lib/swarmCodeProjectFileDefaults", () => ({
  readSwarmCodeProjectFileDefaultThreadEnvMode: () => testState.projectFileRead,
}));
vi.mock("../lib/utils", () => ({
