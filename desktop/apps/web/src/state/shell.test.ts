...
import type { EnvironmentCatalogState } from "@swarmcode/client-runtime/state/connections";
import type { EnvironmentShellState } from "@swarmcode/client-runtime/state/shell";
import { EnvironmentId } from "@swarmcode/contracts";
