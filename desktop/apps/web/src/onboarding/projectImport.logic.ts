import { findProjectByPath } from "@swarmcode/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@swarmcode/contracts";
