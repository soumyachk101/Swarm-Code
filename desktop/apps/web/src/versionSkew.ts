import type { EnvironmentId, ServerConfig, ServerSelfUpdateCapability } from "@swarmcode/contracts";
import type { ServerUpdateState } from "@swarmcode/client-runtime/state/server";
...
/**
 * The skew a user can act on: the connected server runs an older Swarm Code than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same Swarm Code version.",
  };
}
