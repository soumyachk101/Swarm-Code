...
import { VIDEO_FILE_EXTENSIONS } from "@swarmcode/shared/video";
...
const SWARM_CODE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <!-- Lucide Film icon, ISC license. -->
  <symbol id="swarm-code-file-icon-video" viewBox="0 0 24 24">
  ...
  <symbol id="swarm-code-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="swarm-code-file-icon-pnpm" viewBox="0 0 32 32">
...
export const SWARM_CODE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: SWARM_CODE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "file-tree-builtin-npm",
    "tsconfig.json": "file-tree-builtin-typescript",
    "agents.md": "swarm-code-file-icon-agents",
    "pnpm-lock.yaml": "swarm-code-file-icon-pnpm",
    "pnpm-workspace.yaml": "swarm-code-file-icon-pnpm",
  },
  byFileExtension: Object.fromEntries(
    VIDEO_FILE_EXTENSIONS.map((extension) => [extension, "swarm-code-file-icon-video"]),
  ),
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${SWARM_CODE_FILE_ICON_SPRITE}`;
