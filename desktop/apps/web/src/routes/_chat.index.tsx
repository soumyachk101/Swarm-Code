...
import { scopeProjectRef } from "@swarmcode/client-runtime/environment";
...
function HostedStaticOnboardingState() {
  ...
  const description = localEnvironmentOff
    ...
    : cloudEnabled
      ? "Enable Swarm Connect on that machine, then open Connections here to sign in with the same account. You can also add the machine using a pairing link."
          ...
          <div className="w-full max-w-xl rounded-3xl border border-border/55 bg-card/20 px-8 py-12 shadow-sm/5">
            <EmptyHeader className="max-w-none">
              ...
              <EmptyTitle className="text-foreground text-xl">
                Connect to a computer running Swarm Code
              </EmptyTitle>
              <EmptyDescription className="mt-2 text-sm leading-relaxed text-muted-foreground/78">
                This app connects to Swarm Code running on your computer or a server. Start the Swarm Code
