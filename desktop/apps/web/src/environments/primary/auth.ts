...
import { EnvironmentHttpCommonError, PRIMARY_LOCAL_ENVIRONMENT_ID } from "@swarmcode/contracts";
import type { EnvironmentHttpCommonError as EnvironmentHttpCommonErrorType } from "@swarmcode/contracts";
