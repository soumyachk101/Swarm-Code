...
export const triageCommand = Command.make("triage", {
  ...
  Command.withDescription(
    "Investigate a Swarm Code problem on this machine with claude or codex, and help file a good issue.",
  ),
  Command.withHandler((flags) =>
    Effect.gen(function* () {
      ...
      // --base-dir wins; SWARMCODE_HOME is its documented env equivalent (same
