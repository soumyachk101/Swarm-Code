...
/**
 * What `swarm-code uninstall` would remove for one Swarm Code home. Computed before anything
...
const runUninstall = Effect.fn("cli.uninstall.run")(function* (input: {
  ...
  yield* Console.log("");
  yield* Console.log("t3 is uninstalled. Thanks for trying Swarm Code.");
});
