...
import { sanitizeBranchFragment } from "@swarmcode/shared/git";
import {
  detectSourceControlProviderFromRemoteUrl,
  isSshRemoteUrl,
} from "@swarmcode/shared/sourceControl";
...
const BitbucketApiEnvConfig = Config.all({
  baseUrl: Config.String("SWARMCODE_BITBUCKET_API_BASE_URL").pipe(
    Config.withDefault(DEFAULT_API_BASE_URL),
  ),
  accessToken: Config.String("SWARMCODE_BITBUCKET_ACCESS_TOKEN").pipe(Config.option),
  email: Config.String("SWARMCODE_BITBUCKET_EMAIL").pipe(Config.option),
  apiToken: Config.String("SWARMCODE_BITBUCKET_API_TOKEN").pipe(Config.option),
});
...
function authFromConfig(
  ...
  return {
    ...
    host: Option.some("bitbucket.org"),
    detail: Option.some(
      "Set SWARMCODE_BITBUCKET_EMAIL and SWARMCODE_BITBUCKET_API_TOKEN, or SWARMCODE_BITBUCKET_ACCESS_TOKEN.",
    ),
  };
}
