...
import { GitCommandError } from "@swarmcode/contracts";
    ...
    Layer.provide(
      ConfigProvider.layer(
        ConfigProvider.fromEnv({
          env: {
            SWARMCODE_BITBUCKET_API_BASE_URL: "https://api.test.local/2.0",
            SWARMCODE_BITBUCKET_EMAIL: "user@example.com",
            SWARMCODE_BITBUCKET_API_TOKEN: "token",
          },
        }),
      ),
    ),
