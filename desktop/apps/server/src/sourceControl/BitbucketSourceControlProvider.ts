...
import { SourceControlProviderError, type ChangeRequest } from "@swarmcode/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set SWARMCODE_BITBUCKET_EMAIL and SWARMCODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
