...
import { isDevProxiedPath } from "@swarmcode/shared/devProxy";
import { decodeOtlpTraceRecords } from "@swarmcode/shared/observability";
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // SWARMCODE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
