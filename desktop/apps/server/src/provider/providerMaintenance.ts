...
import { resolveCommandPath } from "@swarmcode/shared/shell";
...
export const ProviderVersionCache = Context.Reference<Map<string, ProviderVersionCacheEntry>>(
  "@swarmcode/server/providerMaintenance/ProviderVersionCache",
  {
 ...
 * owns that path; anything unproven stays manual-only so Swarm Code never runs
