import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@swarmcode/contracts";
...
import { normalizeModelSlug } from "@swarmcode/shared/model";
...
const SWARM_CODE_OAUTH_REFERRER = "t3code";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: SWARM_CODE_OAUTH_REFERRER,
    },
  };
}
