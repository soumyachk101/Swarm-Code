import { tokenizeCliArgs } from "@swarmcode/shared/cliArgs";

const SWARMCODE_CODEX_LAUNCH_ARGS_ENV = "SWARMCODE_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[SWARMCODE_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
