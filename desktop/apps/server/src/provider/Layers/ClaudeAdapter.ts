...
import { parseCliArgs } from "@swarmcode/shared/cliArgs";
...
} from "@swarmcode/shared/claudeCompaction";
import { HostProcessIsExecutable } from "@swarmcode/shared/hostProcess";
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleResumeDialog = Effect.fn("handleResumeDialog")(function* (
        ...
        // The question copy lives in @swarmcode/shared/claudeCompaction because
