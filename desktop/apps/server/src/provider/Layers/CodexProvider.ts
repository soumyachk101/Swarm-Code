...
import { PREFERRED_DEFAULT_CODEX_MODELS, ServerSettingsError } from "@swarmcode/contracts";
    ...
    if (!codexSettings.enabled) {
      return buildServerProvider({
        ...
        probe: {
          ...
          status: "warning",
          auth: { status: "unknown" },
          message: "Codex is disabled in Swarm Code settings.",
        },
      });
    }
