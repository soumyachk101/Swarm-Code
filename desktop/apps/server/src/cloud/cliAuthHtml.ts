...
declare const __SWARMCODE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __SWARMCODE_BUILD_CHANNEL__ === "undefined" ? "dev" : __SWARMCODE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Swarm Code (Dev)",
  nightly: "Swarm Code (Nightly)",
  latest: "Swarm Code",
