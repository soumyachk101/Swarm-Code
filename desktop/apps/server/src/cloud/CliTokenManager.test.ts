...
const TEST_ENV = {
  SWARMCODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  SWARMCODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  SWARMCODE_HOSTED_APP_URL: "https://hosted.example.test",
};
