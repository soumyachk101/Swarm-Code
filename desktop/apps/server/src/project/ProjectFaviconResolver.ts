...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* SwarmCodeProjectFileLoader.SwarmCodeProjectFileLoader;
  ...
  const resolvePathUncached = Effect.fn("ProjectFaviconResolver.resolvePathUncached")(function* (
    ...
    // A swarmCode.json iconPath takes precedence over the well-known locations.
