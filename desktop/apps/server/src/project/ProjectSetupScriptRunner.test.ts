...
import { type OrchestrationProject, ProjectId, type TerminalEvent } from "@swarmcode/contracts";
  ...
  it.effect("runs the inherited machine setup action in the checkout's worktree", () => {
    ...
    return Effect.gen(function* () {
      ...
      expect(open).toHaveBeenCalledWith({
        ...
        worktreePath: "/repo/worktrees/a",
        env: {
          SWARMCODE_PROJECT_ROOT: "/repo/project",
          SWARMCODE_WORKTREE_PATH: "/repo/worktrees/a",
          NO_COLOR: "1",
          FORCE_COLOR: "0",
        },
      });
